...
> **Major Update**: New features, AI Agent support, code cleanup, and V1 API migration!

| Feature | Description |
|---------|-------------|
| **💻 Technographics** | Discover company technology stacks (frameworks, analytics, marketing tools) |
| **🔄 Job Change Detector** | Monitor contacts for career transitions (3 credits per check) |
| **🏆 Competitors Search** | Find and analyze company competitors with market intelligence |
| **🌎 Job Regions/Industries** | New job filtering by region, industry, and company type |
| **🤖 AI Agent Support** | `usableAsTool: true` enables use as an AI agent tool |
| **📡 V1 API Migration** | Updated to use LeadMagic's latest V1 API endpoints |
| **📋 New Templates** | 3 new workflow templates for new features |
...
- Frameworks, analytics, marketing tools
...
**🆕 🔄 Job Change Detector**
- Monitor career transitions
- Detect company changes
- Full work history & tenure stats
...
| **🆕 💻 Technographics** | Tech stack analysis | Discover company technologies |
| **🆕 🔄 Job Change Monitor** | Career transition alerts | Monitor contacts for job changes |
| **🆕 🏆 Competitor Analysis** | Market intelligence | Find and analyze competitors |
...
| **🏢 Company** | 4 operations | ✅ 100% | 300/min |
| **👤 Profile** | 3 operations | ✅ 100% | 300/min |
| **👥 People** | 3 operations | ✅ 100% | 300/min |
| **💼 Jobs** | 6 operations | ✅ 100% | 300/min |
| **📱 Ads** | 4 operations | ✅ 100% | 300/min |
| **💳 Credits** | 1 operation | ✅ 100% | 300/min |

**Total: 25 Operations • 7 Resources • 100% API Coverage • AI Agent Compatible**
